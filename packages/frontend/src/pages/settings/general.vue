	...
	<FormSection>
		...
		<div class="_gaps_m">
			<div class="_gaps_s">
				...
				<MkSwitch v-model="showPostedToast">{{ i18n.ts.showPostedToast }} <span class="_beta">MkP</span></MkSwitch>
...
const showPostedToast = computed(defaultStore.makeGetterSetter('showPostedToast'));
