		...
		<SearchMarker :keywords="['bottom']">
			<FormSection>
				...
				<div class="_gaps_m">
					...
					<MkSwitch v-model="showReloadButtonInNavbar" :disabled="!isMobile">
						<template #label><i class="ti ti-refresh"></i> <SearchLabel>{{ i18n.ts.reload }}</SearchLabel></template>
					</MkSwitch>
...
const showReloadButtonInNavbar = computed(defaultStore.makeGetterSetter('showReloadButtonInNavbar'));
