	...
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			const query = this.queryService.makePaginationQuery(this.notesRepository.createQueryBuilder('note'),
				...
				.andWhere('(note.userHost IN (:...hosts) OR note.userHost IS NULL)', { hosts: this.serverSettings.bubbleInstances })
				.andWhere("(note.replyId IS NULL OR reply.userHost IS NULL OR reply.userHost = ANY (:recommendedHosts))", { recommendedHosts: this.serverSettings.bubbleInstances })
